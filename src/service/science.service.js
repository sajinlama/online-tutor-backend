...
/**
 * Creates or updates the ScienceScore document for a user with the
...
export const updateUserProgress = async (userId, correctAnswers) => {
  ...
  if (!userProgress) {
    userProgress = new UserProgress({
      userId,
      subjects: {
        science: { totalScore: correctAnswers },
        maths: { totalScore: 0 },
        english: { totalScore: 0 },
      },
    });
  } else {
    userProgress.subjects.science.totalScore = correctAnswers;
  }
