import { 
  ...
  updateEnglishScore,
  updateUserProgress,
} from "../../service/english.service.js";

const checkAnsEnglish = async (req, res) => {
  try {
    ...
    const feedbackData = await getAIFeedbackFromMicroservice(progressArray, "english");

    // 6. Update EnglishScore Document
    await updateEnglishScore({
      userId,
      correctAnswers,
      progressArray,
      feedbackData,
    ...
    console.error("Error checking english answers:", error);
...
export default checkAnsEnglish;